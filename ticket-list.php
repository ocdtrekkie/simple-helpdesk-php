                    ...
                    foreach ($data as $key => $val) {
                        echo "
                            <tr>
                                ...
                                <td>
                                    <a class='btn btn-default' data-toggle='modal' data-target='#ed-".$key."'>Open</a>
                                </td>
                            </tr>
                        ";
                ?>
                        ...
                        <div class="modal-dialog" style="background-color:#FFFFFF;">
                            <form class="modal-content" method="POST">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">Ticket #<?=$val['tt_id'];?></h4>
                                </div>
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label for=""><?=$val['tt_subject'];?></label>
                                            <p><?=$val['tt_message'];?></p><br />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 form-group">
                                            ...
                                            <select name="status" class="form-control" required="true">
                                                <option value="<?=$val['tt_status'];?>">CURRENT: <?=$val['tt_status'];?></option>
